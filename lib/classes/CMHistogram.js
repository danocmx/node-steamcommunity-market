...
class CMHistogram extends CMResponse {
	/**
     * @constructor
     * @param {CommunityMarket} communityMarket
     * @param {object} params
     * @param {object} data
     */
	...
	update(params) {
		...
		Object.assign(histogramParams, this.params);
		Object.assign(histogramParams, params);

		return this.communityMarket.getHistogram(histogramParams)
			.then((histogram) => {
